...
public class TongCacGiaTriLeTrenMotCotCuaMaTran {
    ...
    // Hàm tính tổng các giá trị trên một cột của ma trận
    public static void TongCacGiaTriLeTrenMotCot(int a[][], int soDong, int soCot) {
        for (int i = 0; i < soDong; i++) {
            long sum = 0;
            for(int j=0;j<soCot;j++){
                if(a[i][j] % 2 != 0)
            ...
            System.out.println("Tong cac gia tri cot " + i + " = "+ sum);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        TongCacGiaTriLeTrenMotCot(a, soDong, soCot);
    }
}
